...
const configPath = path.join(projectPath,'./example/tinypack.config.js')
const relapath=path.dirname(configPath)
const config = require(configPath)

// console.log(path.join(relapath, config.entry))

const graph = createGraph(path.join(relapath, config.entry));
